...
public static class SetsAndMaps
{
    ...
    public static string[] FindPairs(string[] words)
    {
        ...
        for (int i = 0; i < words.Length; i++)
        {
            ...
            if (wordSet.Contains(reversedWord) && word != reversedWord)
            {
                ...
                // Add to result list (ensure each pair is added only once)
    ...
    public static bool IsAnagram(string word1, string word2)
    {
        ...
        string cleanedWord1 = new string(word1.Where(c => !char.IsWhiteSpace(c)).ToArray()).ToLower();
        string cleanedWord2 = new string(word2.Where(c => !char.IsWhiteSpace(c)).ToArray()).ToLower();
